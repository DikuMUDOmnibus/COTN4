...
double xp_compute args((CHAR_DATA * gch, CHAR_DATA * victim));
...
int number_attacks(CHAR_DATA * ch, CHAR_DATA * victim)
{
	...
	{
        // Player Focus (Skill)
        if (ch->ability_cur == 2)  count += ch->ability[2] / 20;
        // Player Focus (Agility)
        if (ch->ability_cur == 4)  count += ch->ability[4] / 20;
	}
...
if (IS_CLASS(ch, CLASS_DEMON)) count += balance[0].number_attacks;
if (IS_CLASS(ch, CLASS_WEREWOLF)) count += balance[1].number_attacks;
if (IS_CLASS(ch, CLASS_DROW)) count += balance[2].number_attacks;
if (IS_CLASS(ch, CLASS_NINJA)) count += balance[3].number_attacks;
if (IS_CLASS(ch, CLASS_VAMPIRE)) count += balance[4].number_attacks;
if (IS_CLASS(ch, CLASS_MONK)) count += balance[5].number_attacks;
if (IS_CLASS(ch, CLASS_MAGE)) count += balance[6].number_attacks;
if (IS_CLASS(ch, CLASS_TANARRI)) count += balance[7].number_attacks;
if (IS_CLASS(ch, CLASS_SHAPESHIFTER)) count += balance[8].number_attacks;
if (IS_CLASS(ch, CLASS_CYBORG)) count += balance[9].number_attacks;
if (IS_CLASS(ch, CLASS_SAMURAI)) count += balance[10].number_attacks;
if (IS_CLASS(ch, CLASS_UNDEAD_KNIGHT)) count += balance[11].number_attacks;
if (IS_CLASS(ch, CLASS_ANGEL)) count += balance[12].number_attacks;
if (IS_CLASS(ch, CLASS_LICH)) count += balance[13].number_attacks;
if (IS_CLASS(ch, CLASS_HOBBIT)) count += balance[14].number_attacks;
if (IS_CLASS(ch, CLASS_GIANT)) count += balance[15].number_attacks;
if (IS_CLASS(ch, CLASS_FAE)) count += balance[16].number_attacks;
if (IS_CLASS(ch, CLASS_DRONE)) count += balance[17].number_attacks;
if (IS_CLASS(ch, CLASS_JEDI)) count += balance[18].number_attacks;
if (IS_CLASS(ch, CLASS_SKYBLADE)) count += balance[19].number_attacks;
if (IS_CLASS(ch, CLASS_PRIEST)) count += balance[20].number_attacks;
if (IS_CLASS(ch, CLASS_GHOUL)) count += balance[21].number_attacks;
if (IS_CLASS(ch, CLASS_DRACONIAN)) count += balance[22].number_attacks;
if (IS_CLASS(ch, CLASS_THIEF)) count += balance[23].number_attacks;
if (IS_CLASS(ch, CLASS_ELEMENTAL)) count += balance[24].number_attacks;
if (IS_CLASS(ch, CLASS_PALADIN)) count += balance[25].number_attacks;
if (IS_CLASS(ch, CLASS_BLADE_MASTER)) count += balance[26].number_attacks;
if (IS_CLASS(ch, CLASS_DRAGON)) count += balance[27].number_attacks;
if (IS_CLASS(ch, CLASS_ZOMBIE)) count += balance[28].number_attacks;
if (IS_CLASS(ch, CLASS_SHINOBI)) count += balance[29].number_attacks;
if (IS_CLASS(ch, CLASS_ANTIPALADIN)) count += balance[30].number_attacks;
if (IS_CLASS(ch, CLASS_SHADOW)) count += balance[31].number_attacks;
...
/*	  if (IS_CLASS(ch, CLASS_VAMPIRE))
		...
		if (IS_SET(ch->pcdata->powers[15], APOWER_SPEED)) count += 2;
                ...
                else if (IS_CLASS(ch, CLASS_WEREWOLF))
                {
                    ...
                    count += ch->pcdata->powers[WEAPONSKILL] / 1.4;
...
void one_hit(CHAR_DATA * ch, CHAR_DATA * victim, int dt, int handtype)
{
	...
	// Player Focus (Toughness)
//	if (!IS_NPC(victim) && victim->ability_cur == 0) dam /= victim->ability[0] / 40;

        // Player Focus (Toughness) 
        if (ch->ability_cur == 0) dam += ch->ability[0] * 4;

        // Player Focus (Power)
        if (ch->ability_cur == 1) dam += ch->ability[1] * 4;
        ...
        if (!IS_NPC(victim))
	{
          ...
          else if (IS_CLASS(victim, CLASS_SHADOW))
	  {
        ...
        else if (dt == gsn_takaura) dam *= 6;
        else if (dt == gsn_malice) dam *= 6;
	else if (dt == gsn_jugularslice) dam *= 7;
        else if (dt == gsn_shinfire) dam *= 7;
        else if (dt == gsn_shinwater) dam *= 7;
        else if (dt == gsn_shinholy) dam *= 7;
        else if (dt == gsn_shinshadow) dam *= 7;
        else if (dt == gsn_shinwind) dam *= 7;
        else if (dt == gsn_shinearth) dam *= 7;
...
int cap_dam(CHAR_DATA * ch, CHAR_DATA * victim, int dam)
{
	...
	if (!IS_NPC(victim))
	{
	 ...
	 dam /=1.3;
	  ...
	  else if(!IS_NPC(victim) && IS_CLASS(victim, CLASS_ZOMBIE))
	  {
	    dam /= 2;
...
/*          if (IS_CLASS(ch, CLASS_HOBBIT))
	  ...
	  else if (IS_CLASS(ch, CLASS_ANTIPALADIN)) max_dam +=  ch->pcdata->powers[DARKARTS] * 120;
          else if (IS_CLASS(ch, CLASS_DRONE))
                {
                        max_dam +=
...
*/
if (IS_CLASS(ch, CLASS_DEMON)) max_dam += balance[0].damcap;
if (IS_CLASS(ch, CLASS_WEREWOLF)) max_dam += balance[1].damcap;
if (IS_CLASS(ch, CLASS_DROW)) max_dam += balance[2].damcap;
if (IS_CLASS(ch, CLASS_NINJA)) max_dam += balance[3].damcap;
if (IS_CLASS(ch, CLASS_VAMPIRE)) max_dam += balance[4].damcap;
if (IS_CLASS(ch, CLASS_MONK)) max_dam += balance[5].damcap;
if (IS_CLASS(ch, CLASS_MAGE)) max_dam += balance[6].damcap;
if (IS_CLASS(ch, CLASS_TANARRI)) max_dam += balance[7].damcap;
if (IS_CLASS(ch, CLASS_SHAPESHIFTER)) max_dam += balance[8].damcap;
if (IS_CLASS(ch, CLASS_CYBORG)) max_dam += balance[9].damcap;
if (IS_CLASS(ch, CLASS_SAMURAI)) max_dam += balance[10].damcap;
if (IS_CLASS(ch, CLASS_UNDEAD_KNIGHT)) max_dam += balance[11].damcap;
if (IS_CLASS(ch, CLASS_ANGEL)) max_dam += balance[12].damcap;
if (IS_CLASS(ch, CLASS_LICH)) max_dam += balance[13].damcap;
if (IS_CLASS(ch, CLASS_HOBBIT)) max_dam += balance[14].damcap;
if (IS_CLASS(ch, CLASS_GIANT)) max_dam += balance[15].damcap;
if (IS_CLASS(ch, CLASS_FAE)) max_dam += balance[16].damcap;
if (IS_CLASS(ch, CLASS_DRONE)) max_dam += balance[17].damcap;
if (IS_CLASS(ch, CLASS_JEDI)) max_dam += balance[18].damcap;
if (IS_CLASS(ch, CLASS_SKYBLADE)) max_dam += balance[19].damcap;
if (IS_CLASS(ch, CLASS_PRIEST)) max_dam += balance[20].damcap;
if (IS_CLASS(ch, CLASS_GHOUL)) max_dam += balance[21].damcap;
if (IS_CLASS(ch, CLASS_DRACONIAN)) max_dam += balance[22].damcap;
if (IS_CLASS(ch, CLASS_THIEF)) max_dam += balance[23].damcap;
if (IS_CLASS(ch, CLASS_ELEMENTAL)) max_dam += balance[24].damcap;
if (IS_CLASS(ch, CLASS_PALADIN)) max_dam += balance[25].damcap;
if (IS_CLASS(ch, CLASS_BLADE_MASTER)) max_dam += balance[26].damcap;
if (IS_CLASS(ch, CLASS_DRAGON)) max_dam += balance[27].damcap;
if (IS_CLASS(ch, CLASS_ZOMBIE)) max_dam += balance[28].damcap;
if (IS_CLASS(ch, CLASS_SHINOBI)) max_dam += balance[29].damcap;
if (IS_CLASS(ch, CLASS_ANTIPALADIN)) max_dam += balance[30].damcap;
if (IS_CLASS(ch, CLASS_SHADOW)) max_dam += balance[31].damcap;
...
void hurt_person(CHAR_DATA * ch, CHAR_DATA * victim, int dam)
{
	...
	ch->symbiotepoints++;
        stc("#GYour Symbiote gains a point#n.\n\r", ch);
                        ...
                        if (IS_CLASS(ch, CLASS_GHOUL))
                        {
		                  ...
		                  if (ch->pcdata->stats[GHOUL_PTS] >= 1000000) {
		                  ch->pcdata->stats[GHOUL_PTS] = 1000000; }
                        }
			    ...
			    || IS_CLASS(ch, CLASS_ANTIPALADIN))
					...
					ch->pcdata->powers[ZOM_FLESH] += 4;
                                        ...
                                        if (IS_CLASS(ch, CLASS_DEMON) || IS_CLASS(ch, CLASS_ANTIPALADIN))
                                        {
                                                if (global_cp)
                                                {
                                                        ch->pcdata->
                                        ...
                                        {
                                                xprintf(buf,
                                                        "#R-#0=Double CP#0=#R- #0You gain #R(#Y%d#R)#0 class points.#n\n\r",
                                                        victim->level * 4);
                                                ch->total_cp_gained +=
                                                        victim->level * 4;
                                        }
					...
					{
                                                xprintf(buf,
                                                        "#0You gain #R(#Y%dR0)#0 class points.#n\n\r",
                                                        victim->level * 2);
                                                ch->total_cp_gained +=
                                                        victim->level * 2;
					}
                        ...
                        if (IS_CLASS(ch, CLASS_SHADOW))
                        {
                                ...
                                {
                                        xprintf(buf,
                                                "#0You gain #R(#Y%d#R)#0 class points.#n\n\r",
                                                victim->level * 2);
                                        ch->total_cp_gained +=
                                                victim->level * 2;
                                }
                        ...
                        if (ch->level == 1 && ch->mkill > 4)
                        {
                                ...
                                do_save(ch, "");
                                send_to_char
                                        ("#RYour char is now saved, enjoy Cotn 4!#n\n\r",
                                         ch);
                        }
                }
                if (!IS_NPC(victim) && IS_NPC(ch))
    ...
    if ( !IS_NPC(ch) && IS_NPC(victim) )
    {
        if ( IS_SET(ch->act2, PLR_AUTOSAC) && !IS_CLASS(ch, CLASS_DRAGON))
...
/* ------------ This is the end for superstances, Jobo ------------------- */
        ...
        if (!IS_NPC(ch))
        {
        // Player Focus (Prowess)
        if (ch->ability_cur == 3)  chance -= ch->ability[3]  / 10;
...
if (IS_CLASS(ch, CLASS_NINJA)) chance -= balance[3].parry;
if (IS_CLASS(ch, CLASS_VAMPIRE)) chance -= balance[4].parry;
if (IS_CLASS(ch, CLASS_MONK)) chance -= balance[5].parry;
if (IS_CLASS(ch, CLASS_MAGE)) chance -= balance[6].parry;
if (IS_CLASS(ch, CLASS_TANARRI)) chance -= balance[7].parry;
if (IS_CLASS(ch, CLASS_SHAPESHIFTER)) chance -= balance[8].parry;
if (IS_CLASS(ch, CLASS_CYBORG)) chance -= balance[9].parry;
if (IS_CLASS(ch, CLASS_SAMURAI)) chance -= balance[10].parry;
if (IS_CLASS(ch, CLASS_UNDEAD_KNIGHT)) chance -= balance[11].parry;
if (IS_CLASS(ch, CLASS_ANGEL)) chance -= balance[12].parry;
if (IS_CLASS(ch, CLASS_LICH)) chance -= balance[13].parry;
if (IS_CLASS(ch, CLASS_HOBBIT)) chance -= balance[14].parry;
if (IS_CLASS(ch, CLASS_GIANT)) chance -= balance[15].parry;
if (IS_CLASS(ch, CLASS_FAE)) chance -= balance[16].parry;
if (IS_CLASS(ch, CLASS_DRONE)) chance -= balance[17].parry;
if (IS_CLASS(ch, CLASS_JEDI)) chance -= balance[18].parry;
if (IS_CLASS(ch, CLASS_SKYBLADE)) chance -= balance[19].parry;
if (IS_CLASS(ch, CLASS_PRIEST)) chance -= balance[20].parry;
if (IS_CLASS(ch, CLASS_GHOUL)) chance -= balance[21].parry;
if (IS_CLASS(ch, CLASS_DRACONIAN)) chance -= balance[22].parry;
if (IS_CLASS(ch, CLASS_THIEF)) chance -= balance[23].parry;
if (IS_CLASS(ch, CLASS_ELEMENTAL)) chance -= balance[24].parry;
if (IS_CLASS(ch, CLASS_PALADIN)) chance -= balance[25].parry;
if (IS_CLASS(ch, CLASS_BLADE_MASTER)) chance -= balance[26].parry;
if (IS_CLASS(ch, CLASS_DRAGON)) chance -= balance[27].parry;
if (IS_CLASS(ch, CLASS_ZOMBIE)) chance -= balance[28].parry;
if (IS_CLASS(ch, CLASS_SHINOBI)) chance -= balance[29].parry;
if (IS_CLASS(ch, CLASS_ANTIPALADIN)) chance -= balance[30].parry;
if (IS_CLASS(ch, CLASS_SHADOW)) chance -= balance[31].parry;
...
*/
        // Player Focus (Prowess)
        if (victim->ability_cur == 3)  chance += victim->ability[3]  / 10;
...
if (IS_CLASS(victim, CLASS_NINJA)) chance += balance[3].parry;
if (IS_CLASS(victim, CLASS_VAMPIRE)) chance += balance[4].parry;
if (IS_CLASS(victim, CLASS_MONK)) chance += balance[5].parry;
if (IS_CLASS(victim, CLASS_MAGE)) chance += balance[6].parry;
if (IS_CLASS(victim, CLASS_TANARRI)) chance += balance[7].parry;
if (IS_CLASS(victim, CLASS_SHAPESHIFTER)) chance += balance[8].parry;
if (IS_CLASS(victim, CLASS_CYBORG)) chance += balance[9].parry;
if (IS_CLASS(victim, CLASS_SAMURAI)) chance += balance[10].parry;
if (IS_CLASS(victim, CLASS_UNDEAD_KNIGHT)) chance += balance[11].parry;
if (IS_CLASS(victim, CLASS_ANGEL)) chance += balance[12].parry;
if (IS_CLASS(victim, CLASS_LICH)) chance += balance[13].parry;
if (IS_CLASS(victim, CLASS_HOBBIT)) chance += balance[14].parry;
if (IS_CLASS(victim, CLASS_GIANT)) chance += balance[15].parry;
if (IS_CLASS(victim, CLASS_FAE)) chance += balance[16].parry;
if (IS_CLASS(victim, CLASS_DRONE)) chance += balance[17].parry;
if (IS_CLASS(victim, CLASS_JEDI)) chance += balance[18].parry;
if (IS_CLASS(victim, CLASS_SKYBLADE)) chance += balance[19].parry;
if (IS_CLASS(victim, CLASS_PRIEST)) chance += balance[20].parry;
if (IS_CLASS(victim, CLASS_GHOUL)) chance += balance[21].parry;
if (IS_CLASS(victim, CLASS_DRACONIAN)) chance += balance[22].parry;
if (IS_CLASS(victim, CLASS_THIEF)) chance += balance[23].parry;
if (IS_CLASS(victim, CLASS_ELEMENTAL)) chance += balance[24].parry;
if (IS_CLASS(victim, CLASS_PALADIN)) chance += balance[25].parry;
if (IS_CLASS(victim, CLASS_BLADE_MASTER)) chance += balance[26].parry;
if (IS_CLASS(victim, CLASS_DRAGON)) chance += balance[27].parry;
if (IS_CLASS(victim, CLASS_ZOMBIE)) chance += balance[28].parry;
if (IS_CLASS(victim, CLASS_SHINOBI)) chance += balance[29].parry;
if (IS_CLASS(victim, CLASS_ANTIPALADIN)) chance += balance[30].parry;
if (IS_CLASS(victim, CLASS_SHADOW)) chance += balance[31].parry;
...
if (!IS_NPC(ch) && IS_CLASS(ch, CLASS_DEMON)) chance -= balance[0].parry;
if (!IS_NPC(ch) && IS_CLASS(ch, CLASS_WEREWOLF)) chance -= balance[1].parry;
if (!IS_NPC(ch) && IS_CLASS(ch, CLASS_DROW)) chance -= balance[2].parry;
if (!IS_NPC(ch) && IS_CLASS(ch, CLASS_NINJA)) chance -= balance[3].parry;
if (!IS_NPC(ch) && IS_CLASS(ch, CLASS_VAMPIRE)) chance -= balance[4].parry;
if (!IS_NPC(ch) && IS_CLASS(ch, CLASS_MONK)) chance -= balance[5].parry;
if (!IS_NPC(ch) && IS_CLASS(ch, CLASS_MAGE)) chance -= balance[6].parry;
if (!IS_NPC(ch) && IS_CLASS(ch, CLASS_TANARRI)) chance -= balance[7].parry;
if (!IS_NPC(ch) && IS_CLASS(ch, CLASS_SHAPESHIFTER)) chance -= balance[8].parry;
if (!IS_NPC(ch) && IS_CLASS(ch, CLASS_CYBORG)) chance -= balance[9].parry;
if (!IS_NPC(ch) && IS_CLASS(ch, CLASS_SAMURAI)) chance -= balance[10].parry;
if (!IS_NPC(ch) && IS_CLASS(ch, CLASS_UNDEAD_KNIGHT)) chance -= balance[11].parry;
if (!IS_NPC(ch) && IS_CLASS(ch, CLASS_ANGEL)) chance -= balance[12].parry;
if (!IS_NPC(ch) && IS_CLASS(ch, CLASS_LICH)) chance -= balance[13].parry;
if (!IS_NPC(ch) && IS_CLASS(ch, CLASS_HOBBIT)) chance -= balance[14].parry;
if (!IS_NPC(ch) && IS_CLASS(ch, CLASS_GIANT)) chance -= balance[15].parry;
if (!IS_NPC(ch) && IS_CLASS(ch, CLASS_FAE)) chance -= balance[16].parry;
if (!IS_NPC(ch) && IS_CLASS(ch, CLASS_DRONE)) chance -= balance[17].parry;
if (!IS_NPC(ch) && IS_CLASS(ch, CLASS_JEDI)) chance -= balance[18].parry;
if (!IS_NPC(ch) && IS_CLASS(ch, CLASS_SKYBLADE)) chance -= balance[19].parry;
if (!IS_NPC(ch) && IS_CLASS(ch, CLASS_PRIEST)) chance -= balance[20].parry;
if (!IS_NPC(ch) && IS_CLASS(ch, CLASS_GHOUL)) chance -= balance[21].parry;
if (!IS_NPC(ch) && IS_CLASS(ch, CLASS_DRACONIAN)) chance -= balance[22].parry;
if (!IS_NPC(ch) && IS_CLASS(ch, CLASS_THIEF)) chance -= balance[23].parry;
if (!IS_NPC(ch) && IS_CLASS(ch, CLASS_ELEMENTAL)) chance -= balance[24].parry;
if (!IS_NPC(ch) && IS_CLASS(ch, CLASS_PALADIN)) chance -= balance[25].parry;
if (!IS_NPC(ch) && IS_CLASS(ch, CLASS_BLADE_MASTER)) chance -= balance[26].parry;
if (!IS_NPC(ch) && IS_CLASS(ch, CLASS_DRAGON)) chance -= balance[27].parry;
if (!IS_NPC(ch) && IS_CLASS(ch, CLASS_ZOMBIE)) chance -= balance[28].parry;
if (!IS_NPC(ch) && IS_CLASS(ch, CLASS_SHINOBI)) chance -= balance[29].parry;
if (!IS_NPC(ch) && IS_CLASS(ch, CLASS_ANTIPALADIN)) chance -= balance[30].parry;
if (!IS_NPC(ch) && IS_CLASS(ch, CLASS_SHADOW)) chance -= balance[31].parry;



if (!IS_NPC(victim) && IS_CLASS(victim, CLASS_DEMON)) chance += balance[0].parry;
if (!IS_NPC(victim) && IS_CLASS(victim, CLASS_WEREWOLF)) chance += balance[1].parry;
if (!IS_NPC(victim) && IS_CLASS(victim, CLASS_DROW)) chance += balance[2].parry;
if (!IS_NPC(victim) && IS_CLASS(victim, CLASS_NINJA)) chance += balance[3].parry;
if (!IS_NPC(victim) && IS_CLASS(victim, CLASS_VAMPIRE)) chance += balance[4].parry;
if (!IS_NPC(victim) && IS_CLASS(victim, CLASS_MONK)) chance += balance[5].parry;
if (!IS_NPC(victim) && IS_CLASS(victim, CLASS_MAGE)) chance += balance[6].parry;
if (!IS_NPC(victim) && IS_CLASS(victim, CLASS_TANARRI)) chance += balance[7].parry;
if (!IS_NPC(victim) && IS_CLASS(victim, CLASS_SHAPESHIFTER)) chance += balance[8].parry;
if (!IS_NPC(victim) && IS_CLASS(victim, CLASS_CYBORG)) chance += balance[9].parry;
if (!IS_NPC(victim) && IS_CLASS(victim, CLASS_SAMURAI)) chance += balance[10].parry;
if (!IS_NPC(victim) && IS_CLASS(victim, CLASS_UNDEAD_KNIGHT)) chance += balance[11].parry;
if (!IS_NPC(victim) && IS_CLASS(victim, CLASS_ANGEL)) chance += balance[12].parry;
if (!IS_NPC(victim) && IS_CLASS(victim, CLASS_LICH)) chance += balance[13].parry;
if (!IS_NPC(victim) && IS_CLASS(victim, CLASS_HOBBIT)) chance += balance[14].parry;
if (!IS_NPC(victim) && IS_CLASS(victim, CLASS_GIANT)) chance += balance[15].parry;
if (!IS_NPC(victim) && IS_CLASS(victim, CLASS_FAE)) chance += balance[16].parry;
if (!IS_NPC(victim) && IS_CLASS(victim, CLASS_DRONE)) chance += balance[17].parry;
if (!IS_NPC(victim) && IS_CLASS(victim, CLASS_JEDI)) chance += balance[18].parry;
if (!IS_NPC(victim) && IS_CLASS(victim, CLASS_SKYBLADE)) chance += balance[19].parry;
if (!IS_NPC(victim) && IS_CLASS(victim, CLASS_PRIEST)) chance += balance[20].parry;
if (!IS_NPC(victim) && IS_CLASS(victim, CLASS_GHOUL)) chance += balance[21].parry;
if (!IS_NPC(victim) && IS_CLASS(victim, CLASS_DRACONIAN)) chance += balance[22].parry;
if (!IS_NPC(victim) && IS_CLASS(victim, CLASS_THIEF)) chance += balance[23].parry;
if (!IS_NPC(victim) && IS_CLASS(victim, CLASS_ELEMENTAL)) chance += balance[24].parry;
if (!IS_NPC(victim) && IS_CLASS(victim, CLASS_PALADIN)) chance += balance[25].parry;
if (!IS_NPC(victim) && IS_CLASS(victim, CLASS_BLADE_MASTER)) chance += balance[26].parry;
if (!IS_NPC(victim) && IS_CLASS(victim, CLASS_DRAGON)) chance += balance[27].parry;
if (!IS_NPC(victim) && IS_CLASS(victim, CLASS_ZOMBIE)) chance += balance[28].parry;
if (!IS_NPC(victim) && IS_CLASS(victim, CLASS_SHINOBI)) chance += balance[29].parry;
if (!IS_NPC(victim) && IS_CLASS(victim, CLASS_ANTIPALADIN)) chance += balance[30].parry;
if (!IS_NPC(victim) && IS_CLASS(victim, CLASS_SHADOW)) chance += balance[31].parry;
...
/*        if (!IS_NPC(ch) && IS_CLASS(ch, CLASS_GIANT))
	...
	if (!IS_NPC(ch) && IS_CLASS(ch, CLASS_ANTIPALADIN)) chance -= 30;
	if (!IS_NPC(victim) && IS_CLASS(victim, CLASS_ANTIPALADIN)) chance += 30;
...
*/
        // Player Focus (Agility)
        if (ch->ability_cur == 4)  chance -= ch->ability[4]  / 10;
...
if (IS_CLASS(ch, CLASS_NINJA)) chance -= balance[3].dodge;
if (IS_CLASS(ch, CLASS_VAMPIRE)) chance -= balance[4].dodge;
if (IS_CLASS(ch, CLASS_MONK)) chance -= balance[5].dodge;
if (IS_CLASS(ch, CLASS_MAGE)) chance -= balance[6].dodge;
if (IS_CLASS(ch, CLASS_TANARRI)) chance -= balance[7].dodge;
if (IS_CLASS(ch, CLASS_SHAPESHIFTER)) chance -= balance[8].dodge;
if (IS_CLASS(ch, CLASS_CYBORG)) chance -= balance[9].dodge;
if (IS_CLASS(ch, CLASS_SAMURAI)) chance -= balance[10].dodge;
if (IS_CLASS(ch, CLASS_UNDEAD_KNIGHT)) chance -= balance[11].dodge;
if (IS_CLASS(ch, CLASS_ANGEL)) chance -= balance[12].dodge;
if (IS_CLASS(ch, CLASS_LICH)) chance -= balance[13].dodge;
if (IS_CLASS(ch, CLASS_HOBBIT)) chance -= balance[14].dodge;
if (IS_CLASS(ch, CLASS_GIANT)) chance -= balance[15].dodge;
if (IS_CLASS(ch, CLASS_FAE)) chance -= balance[16].dodge;
if (IS_CLASS(ch, CLASS_DRONE)) chance -= balance[17].dodge;
if (IS_CLASS(ch, CLASS_JEDI)) chance -= balance[18].dodge;
if (IS_CLASS(ch, CLASS_SKYBLADE)) chance -= balance[19].dodge;
if (IS_CLASS(ch, CLASS_PRIEST)) chance -= balance[20].dodge;
if (IS_CLASS(ch, CLASS_GHOUL)) chance -= balance[21].dodge;
if (IS_CLASS(ch, CLASS_DRACONIAN)) chance -= balance[22].dodge;
if (IS_CLASS(ch, CLASS_THIEF)) chance -= balance[23].dodge;
if (IS_CLASS(ch, CLASS_ELEMENTAL)) chance -= balance[24].dodge;
if (IS_CLASS(ch, CLASS_PALADIN)) chance -= balance[25].dodge;
if (IS_CLASS(ch, CLASS_BLADE_MASTER)) chance -= balance[26].dodge;
if (IS_CLASS(ch, CLASS_DRAGON)) chance -= balance[27].dodge;
if (IS_CLASS(ch, CLASS_ZOMBIE)) chance -= balance[28].dodge;
if (IS_CLASS(ch, CLASS_SHINOBI)) chance -= balance[29].dodge;
if (IS_CLASS(ch, CLASS_ANTIPALADIN)) chance -= balance[30].dodge;
if (IS_CLASS(ch, CLASS_SHADOW)) chance -= balance[31].dodge;
...
*/
        ...
        // Player Focus (Agility)
        if (victim->ability_cur == 4)  chance += victim->ability[4]  / 10;
...
if (IS_CLASS(victim, CLASS_NINJA)) chance += balance[3].dodge;
if (IS_CLASS(victim, CLASS_VAMPIRE)) chance += balance[4].dodge;
if (IS_CLASS(victim, CLASS_MONK)) chance += balance[5].dodge;
if (IS_CLASS(victim, CLASS_MAGE)) chance += balance[6].dodge;
if (IS_CLASS(victim, CLASS_TANARRI)) chance += balance[7].dodge;
if (IS_CLASS(victim, CLASS_SHAPESHIFTER)) chance += balance[8].dodge;
if (IS_CLASS(victim, CLASS_CYBORG)) chance += balance[9].dodge;
if (IS_CLASS(victim, CLASS_SAMURAI)) chance += balance[10].dodge;
if (IS_CLASS(victim, CLASS_UNDEAD_KNIGHT)) chance += balance[11].dodge;
if (IS_CLASS(victim, CLASS_ANGEL)) chance += balance[12].dodge;
if (IS_CLASS(victim, CLASS_LICH)) chance += balance[13].dodge;
if (IS_CLASS(victim, CLASS_HOBBIT)) chance += balance[14].dodge;
if (IS_CLASS(victim, CLASS_GIANT)) chance += balance[15].dodge;
if (IS_CLASS(victim, CLASS_FAE)) chance += balance[16].dodge;
if (IS_CLASS(victim, CLASS_DRONE)) chance += balance[17].dodge;
if (IS_CLASS(victim, CLASS_JEDI)) chance += balance[18].dodge;
if (IS_CLASS(victim, CLASS_SKYBLADE)) chance += balance[19].dodge;
if (IS_CLASS(victim, CLASS_PRIEST)) chance += balance[20].dodge;
if (IS_CLASS(victim, CLASS_GHOUL)) chance += balance[21].dodge;
if (IS_CLASS(victim, CLASS_DRACONIAN)) chance += balance[22].dodge;
if (IS_CLASS(victim, CLASS_THIEF)) chance += balance[23].dodge;
if (IS_CLASS(victim, CLASS_ELEMENTAL)) chance += balance[24].dodge;
if (IS_CLASS(victim, CLASS_PALADIN)) chance += balance[25].dodge;
if (IS_CLASS(victim, CLASS_BLADE_MASTER)) chance += balance[26].dodge;
if (IS_CLASS(victim, CLASS_DRAGON)) chance += balance[27].dodge;
if (IS_CLASS(victim, CLASS_ZOMBIE)) chance += balance[28].dodge;
if (IS_CLASS(victim, CLASS_SHINOBI)) chance += balance[29].dodge;
if (IS_CLASS(victim, CLASS_ANTIPALADIN)) chance += balance[30].dodge;
if (IS_CLASS(victim, CLASS_SHADOW)) chance += balance[31].dodge;
        }
        if (chance > 80)
                chance = 80;
        else if (chance < 20)
...
*/
if (!IS_NPC(victim) && IS_CLASS(victim, CLASS_DEMON)) chance += balance[0].dodge;
if (!IS_NPC(victim) && IS_CLASS(victim, CLASS_WEREWOLF)) chance += balance[1].dodge;
if (!IS_NPC(victim) && IS_CLASS(victim, CLASS_DROW)) chance += balance[2].dodge;
if (!IS_NPC(victim) && IS_CLASS(victim, CLASS_NINJA)) chance += balance[3].dodge;
if (!IS_NPC(victim) && IS_CLASS(victim, CLASS_VAMPIRE)) chance += balance[4].dodge;
if (!IS_NPC(victim) && IS_CLASS(victim, CLASS_MONK)) chance += balance[5].dodge;
if (!IS_NPC(victim) && IS_CLASS(victim, CLASS_MAGE)) chance += balance[6].dodge;
if (!IS_NPC(victim) && IS_CLASS(victim, CLASS_TANARRI)) chance += balance[7].dodge;
if (!IS_NPC(victim) && IS_CLASS(victim, CLASS_SHAPESHIFTER)) chance += balance[8].dodge;
if (!IS_NPC(victim) && IS_CLASS(victim, CLASS_CYBORG)) chance += balance[9].dodge;
if (!IS_NPC(victim) && IS_CLASS(victim, CLASS_SAMURAI)) chance += balance[10].dodge;
if (!IS_NPC(victim) && IS_CLASS(victim, CLASS_UNDEAD_KNIGHT)) chance += balance[11].dodge;
if (!IS_NPC(victim) && IS_CLASS(victim, CLASS_ANGEL)) chance += balance[12].dodge;
if (!IS_NPC(victim) && IS_CLASS(victim, CLASS_LICH)) chance += balance[13].dodge;
if (!IS_NPC(victim) && IS_CLASS(victim, CLASS_HOBBIT)) chance += balance[14].dodge;
if (!IS_NPC(victim) && IS_CLASS(victim, CLASS_GIANT)) chance += balance[15].dodge;
if (!IS_NPC(victim) && IS_CLASS(victim, CLASS_FAE)) chance += balance[16].dodge;
if (!IS_NPC(victim) && IS_CLASS(victim, CLASS_DRONE)) chance += balance[17].dodge;
if (!IS_NPC(victim) && IS_CLASS(victim, CLASS_JEDI)) chance += balance[18].dodge;
if (!IS_NPC(victim) && IS_CLASS(victim, CLASS_SKYBLADE)) chance += balance[19].dodge;
if (!IS_NPC(victim) && IS_CLASS(victim, CLASS_PRIEST)) chance += balance[20].dodge;
if (!IS_NPC(victim) && IS_CLASS(victim, CLASS_GHOUL)) chance += balance[21].dodge;
if (!IS_NPC(victim) && IS_CLASS(victim, CLASS_DRACONIAN)) chance += balance[22].dodge;
if (!IS_NPC(victim) && IS_CLASS(victim, CLASS_THIEF)) chance += balance[23].dodge;
if (!IS_NPC(victim) && IS_CLASS(victim, CLASS_ELEMENTAL)) chance += balance[24].dodge;
if (!IS_NPC(victim) && IS_CLASS(victim, CLASS_PALADIN)) chance += balance[25].dodge;
if (!IS_NPC(victim) && IS_CLASS(victim, CLASS_BLADE_MASTER)) chance += balance[26].dodge;
if (!IS_NPC(victim) && IS_CLASS(victim, CLASS_DRAGON)) chance += balance[27].dodge;
if (!IS_NPC(victim) && IS_CLASS(victim, CLASS_ZOMBIE)) chance += balance[28].dodge;
if (!IS_NPC(victim) && IS_CLASS(victim, CLASS_SHINOBI)) chance += balance[29].dodge;
if (!IS_NPC(victim) && IS_CLASS(victim, CLASS_ANTIPALADIN)) chance += balance[30].dodge;
if (!IS_NPC(victim) && IS_CLASS(victim, CLASS_SHADOW)) chance += balance[31].dodge;

if (!IS_NPC(ch) && IS_CLASS(ch, CLASS_DEMON)) chance -= balance[0].dodge;
if (!IS_NPC(ch) && IS_CLASS(ch, CLASS_WEREWOLF)) chance -= balance[1].dodge;
if (!IS_NPC(ch) && IS_CLASS(ch, CLASS_DROW)) chance -= balance[2].dodge;
if (!IS_NPC(ch) && IS_CLASS(ch, CLASS_NINJA)) chance -= balance[3].dodge;
if (!IS_NPC(ch) && IS_CLASS(ch, CLASS_VAMPIRE)) chance -= balance[4].dodge;
if (!IS_NPC(ch) && IS_CLASS(ch, CLASS_MONK)) chance -= balance[5].dodge;
if (!IS_NPC(ch) && IS_CLASS(ch, CLASS_MAGE)) chance -= balance[6].dodge;
if (!IS_NPC(ch) && IS_CLASS(ch, CLASS_TANARRI)) chance -= balance[7].dodge;
if (!IS_NPC(ch) && IS_CLASS(ch, CLASS_SHAPESHIFTER)) chance -= balance[8].dodge;
if (!IS_NPC(ch) && IS_CLASS(ch, CLASS_CYBORG)) chance -= balance[9].dodge;
if (!IS_NPC(ch) && IS_CLASS(ch, CLASS_SAMURAI)) chance -= balance[10].dodge;
if (!IS_NPC(ch) && IS_CLASS(ch, CLASS_UNDEAD_KNIGHT)) chance -= balance[11].dodge;
if (!IS_NPC(ch) && IS_CLASS(ch, CLASS_ANGEL)) chance -= balance[12].dodge;
if (!IS_NPC(ch) && IS_CLASS(ch, CLASS_LICH)) chance -= balance[13].dodge;
if (!IS_NPC(ch) && IS_CLASS(ch, CLASS_HOBBIT)) chance -= balance[14].dodge;
if (!IS_NPC(ch) && IS_CLASS(ch, CLASS_GIANT)) chance -= balance[15].dodge;
if (!IS_NPC(ch) && IS_CLASS(ch, CLASS_FAE)) chance -= balance[16].dodge;
if (!IS_NPC(ch) && IS_CLASS(ch, CLASS_DRONE)) chance -= balance[17].dodge;
if (!IS_NPC(ch) && IS_CLASS(ch, CLASS_JEDI)) chance -= balance[18].dodge;
if (!IS_NPC(ch) && IS_CLASS(ch, CLASS_SKYBLADE)) chance -= balance[19].dodge;
if (!IS_NPC(ch) && IS_CLASS(ch, CLASS_PRIEST)) chance -= balance[20].dodge;
if (!IS_NPC(ch) && IS_CLASS(ch, CLASS_GHOUL)) chance -= balance[21].dodge;
if (!IS_NPC(ch) && IS_CLASS(ch, CLASS_DRACONIAN)) chance -= balance[22].dodge;
if (!IS_NPC(ch) && IS_CLASS(ch, CLASS_THIEF)) chance -= balance[23].dodge;
if (!IS_NPC(ch) && IS_CLASS(ch, CLASS_ELEMENTAL)) chance -= balance[24].dodge;
if (!IS_NPC(ch) && IS_CLASS(ch, CLASS_PALADIN)) chance -= balance[25].dodge;
if (!IS_NPC(ch) && IS_CLASS(ch, CLASS_BLADE_MASTER)) chance -= balance[26].dodge;
if (!IS_NPC(ch) && IS_CLASS(ch, CLASS_DRAGON)) chance -= balance[27].dodge;
if (!IS_NPC(ch) && IS_CLASS(ch, CLASS_ZOMBIE)) chance -= balance[28].dodge;
if (!IS_NPC(ch) && IS_CLASS(ch, CLASS_SHINOBI)) chance -= balance[29].dodge;
if (!IS_NPC(ch) && IS_CLASS(ch, CLASS_ANTIPALADIN)) chance -= balance[30].dodge;
if (!IS_NPC(ch) && IS_CLASS(ch, CLASS_SHADOW)) chance -= balance[31].dodge;
        if (chance > 90)
                chance = 90;
        if (!IS_NPC(victim))
        {
...
void group_gain(CHAR_DATA * ch, CHAR_DATA * victim)
{
	...
	bladeexp = ch->bladeexp;
        ...
        for (gch = ch->in_room->people; gch != NULL; gch = gch->next_in_room)
        {
                ...
                xprintf(buf2, "#R-#0===== #YExp modifiers  #R:");
                if ((IS_EVIL(gch) && IS_GOOD(victim))
                    || (IS_GOOD(gch) && IS_EVIL(victim)))
                {
                        xp_modifier += 25;
                        strcat(buf2, " #0alignment#n");
                }
                ...
                {
                        xp_modifier += 200;
                        strcat(buf2, " #0Newbie#n");
                }
                if (global_exp)
                {
                        xp_modifier += 200;
                        strcat(buf2, " #YDouble exp#n");
                }
                if (gch->tick_timer[TIMER_EXPERIENCE] > 0)
                {
                        xp_modifier += 250;
                        strcat(buf2, " #0Fairy#n");
                }
                if (gch->race < 1);
                else if (gch->race < 5)
                {
                ...
                xprintf(buf2, "#0Total modifier #R:#Y %d #0percent bonus\n\r",
                        xp_modifier - 100);
                if (!IS_SET(gch->act, PLR_BRIEF5))
                        send_to_char(buf2, gch);
                if ((get_age(gch) - 17) > 2 && ch->level < 3)
                        xp /= 10;   /* anti mortal exp bot thingie */
                if (gch->exp > 500000000)
                        xp = 50000000;   /* avoid overflow */
                ...
                if (xp < 0)
                        xp = 0;
                xprintf(buf, "#R-#0=You receive #Y%d #0experience points#0=#R-#n\n\r", xp);
                if (ch->generation == 6)
                        expneeded = 13000000;
                else if (ch->generation == 5)
                        expneeded = 150000000;
     ...
     if (ch->pcdata->powers[BLADE_SKILL] == 0)
		...
		gain_ability(gch, xp);
                    ...
                    && familiar->value[1] < 200)
                {
                        ...
                        sprintf(buf,
                                "#R-#0=Your familiar receives #Y%d #0experience points#0=#R-#n\n\r",
                                familiar_exp);
                        if (!IS_SET(ch->act, PLR_BRIEF4))
                                stc(buf, gch);
...
//                  obj->weapon_points++;
    ...
    || ch->pcdata->powers[BLADE_PROWESS] < 20 || ch->pcdata->powers[BLADE_SKILL] < 20))
      {
        bladeexpgain = (xp * .020);
        xp -= (bladeexpgain);
        sprintf(buf, "#0- #wYour Class receives #G%d #wexperience points.#n\n\r",bladeexpgain);
        stc(buf, gch);
	ch->bladeexp += bladeexpgain;

	if (bladeexp >= bladeexpneeded)
	{
     if (ch->pcdata->powers[BLADE_SKILL] == 0)
     {  
  ...
  if (!loc) loc = "(no loc)";
            ...
            (IS_NPC(victim) && IS_SET(victim->act, ACT_NOPARTS)))
        {
                    ...
                    && !IS_VAMPAFF(ch, VAM_CLAWS))
                {
                        if (dam == 0)
                        {
        xprintf( buf1, "$n %s $N's %s #g>#G>#7%d#G<#g<#n", vp, loc, dam );
        xprintf( buf2, "You %s $N's %s #g>#G>#7%d#G<#g<#n", vs, loc, dam );
        xprintf( buf3, "$n %s your %s", vp, loc );
      ...
      else
      {
        xprintf( buf1, "$n %s $N's %s #g>#G>#7%d#G<#g<#n", vp, loc, dam );
        xprintf( buf2, "You %s $N's %s #g>#G>#7%d#G<#g<#n", vs, loc, dam );
        xprintf( buf3, "$n %s your %s #g>#G>#7%d#G<#g<#n", vp, loc, dam );
        critical = TRUE;                        }
                }
                         ...
                         && IS_SET(ch->newbits, NEW_MONKFLAME))
                {
                        ...
                        if (!IS_CLASS(ch, CLASS_WEREWOLF))
                        {
        xprintf(buf1, "$n's #rflaming#n hands hit $N %s %c #g>#G>#7%d#G<#g<#n", vp, loc, dam);
        xprintf(buf2, "Your #rflaming#n hands hit $N %s %c #g>#G>#7%d#G<#g<#n", vs, loc, dam);
        xprintf(buf3, "$n's #rflaming#n hands hit you%s%c #g>#G>#7%d#G<#g<#n", vp, loc, dam);
                        }
                        else
                       {
        xprintf(buf1, "$n's #rflaming#n claws hit $N %s %c #g>#G>#7%d#G<#g<#n", vp, loc, dam);
        xprintf(buf2, "Your #rflaming#n claws hit $N %s %c #g>#G>#7%d#G<#g<#n", vs, loc, dam);
        xprintf(buf3, "$n's #rflaming#n claws hit you%s%c #g>#G>#7%d#G<#g<#n", vp, loc, dam);
			}
                        }
                        else
                        {
        xprintf( buf1, "$n's Claws  hits $N's %s,%s #g>#G>#7%d#G<#g<#n",  loc, vp, dam );
        xprintf( buf2, "Your Claws hits $N's %s,%s #g>#G>#7%d#G<#g<#n", loc, vp, dam );
        xprintf( buf3, "$n's Claws hits your %s,%s #g>#G>#7%d#G<#g<#n",  loc, vp, dam );
//        critical = TRUE;
                ...
                else
                {
                        ...
                        if (dam == 0)
                        {
		        xprintf( buf1, "$n's %s hits $N's %s,%s #g>#G>#7%d#G<#g<#n",  attack, loc, vp, dam );
		        xprintf( buf2, "Your %s hits $N's %s,%s #g>#G>#7%d#G<#g<#n",  attack, loc, vp, dam );
		        xprintf( buf3, "$n's %s hits your %s,%s #g>#G>#7%d#G<#g<#n",  attack, loc, vp, dam );
			}
                        else if (IS_SET(ch->newbits, NEW_MONKFLAME)
                                 && (dam == 0))
                        {
		        xprintf( buf1, "$n's %s flaming $N's %s,%s #g>#G>#7%d#G<#g<#n",  attack, loc, vp, dam );
		        xprintf( buf2, "Your %s flaming $N's %s,%s #g>#G>#7%d#G<#g<#n",  attack, loc, vp, dam );
		        xprintf( buf3, "$n's %s flaming your %s,%s #g>#G>#7%d#G<#g<#n",  attack, loc, vp, dam );
                        }
                        else
                        {
                                if (dt >= 0 && dt < MAX_SKILL)
                                {
		        xprintf( buf1, "$n's %s hits $N's %s,%s #g>#G>#7%d#G<#g<#n",  attack2, loc, vp, dam );
		        xprintf( buf2, "Your %s hits $N's %s,%s #g>#G>#7%d#G<#g<#n",  attack, loc, vp, dam );
		        xprintf( buf3, "$n's %s hits your %s,%s #g>#G>#7%d#G<#g<#n",  attack2, loc, vp, dam );
				}
                                else if (IS_SET(ch->newbits, NEW_MONKFLAME))
                                {
                        xprintf( buf1, "$n's flaming %s hits $N's %s,%s #g>#G>#7%d#G<#g<#n",  attack2, loc, vp, dam );
                        xprintf( buf2, "Your flaming %s hits $N's %s,%s #g>#G>#7%d#G<#g<#n",  attack, loc, vp, dam );
                        xprintf( buf3, "$n's flaming %s hits your %s,%s #g>#G>#7%d#G<#g<#n",  attack2, loc, vp, dam );
                                }
                                else
                                {
                        xprintf( buf1, "$n's %s hits $N's %s,%s #g>#G>#7%d#G<#g<#n",  attack2, loc, vp, dam );
...
//  else if ( (victim->tier) < ch->tier) paradox_punish = TRUE;
  ...
  if (!str_cmp(ch->pcdata->retaliation, victim->name))
  {
    ...
    ch->pcdata->retaliation = str_dup("Noone");
        ...
        /*
         * Restore after decap, Xrak
         */
        send_to_char("Xrakisis gives you a Full Restore.", ch);
        ch->hit = ch->max_hit;
        ch->mana = ch->max_mana;
        ch->move = ch->max_move;
