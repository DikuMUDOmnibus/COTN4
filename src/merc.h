...
#define SQLPASS                   "uoToh7Th"
#define SQLUSER                   "xraMud"
...
#define CCENTER_BASIC_LOAD  4
#define CCENTER_RARE_LOAD   5
...
extern bool its_christmas;
extern bool special_day;
extern bool global_cp;
extern bool double_bones;
...
// Zazel
void    restore_quote   args( ( char *str ) );
...
char    *chanName               args( (int chan) );
void    log_comm                args( (char *ch, char *victim, int channel, char *mes, int class ) );
...
CHANNEL_DATA channel_table[MAX_CHANNEL+1];
