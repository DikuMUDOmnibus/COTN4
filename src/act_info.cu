				...
				break;
                        ...
                        case MAX_LEVEL - 9:
                                if (wch->prefix != NULL)
                                        ...
                                        class = "  #0B#Rully#n       ";
          else if (mightRate > 3500 ) class = "   #7Almighty#n     ";
          else if (mightRate > 3250 ) class = "   #CRuler#n        ";
          else if (mightRate > 3000 ) class = "   #YSupreme#n      ";
          else if (mightRate > 2750 ) class = "   #pKing#n         ";
          else if (mightRate > 2500 ) class = "   #RBaron#n        ";
