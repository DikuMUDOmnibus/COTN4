...
bool double_pracs = FALSE;
bool double_damage = FALSE;
bool global_quest = FALSE;
bool its_christmas = FALSE;
bool special_day = TRUE;
bool double_bones = FALSE;
...
const struct cmd_type cmd_table[] = {
        ...
        {"chi", do_chi, POS_FIGHTING, 3, LOG_NORMAL, CLASS_MONK, 0, 0},
        ...
        {"get", do_get, POS_SITTING, 0, LOG_ALWAYS, 0, 0, 0},
        ...
        {"group", do_group, POS_DEAD, 0, LOG_ALWAYS, 0, 0, 0},
...
/*Thief Commands*/
        ...
        {"wakasashislice", do_wakasashislice, POS_FIGHTING, 3, LOG_NORMAL,
         CLASS_SHADOW, SHADOW_ATTACK, CLASS_MONK},
...
//	{ "chathist",   do_chathist, POS_DEAD, 1, LOG_ALWAYS, 0,0,0},
...
//        {"history", do_zhistory, POS_DEAD, 0, LOG_NORMAL, 0, 0, 0},
        {"replay", do_replay, POS_DEAD, 0, LOG_NORMAL, 0, 0, 0},
//        {"lastmessage", do_chathist, POS_DEAD, 2, LOG_NORMAL, 0, 0, 0},
        ...
        {"junk", do_sacrifice, POS_STANDING, 3, LOG_ALWAYS, 0, 0, 0},
        ...
        {"pray", do_pray, POS_MEDITATING, 1, LOG_NORMAL, CLASS_MONK, 0, 0},

// Xrakisis
    { "calc",           do_calc,        POS_DEAD,                 3,  LOG_ALWAYS, 0,0,0 },
    { "ability",        do_ability,        POS_DEAD,                 3,  LOG_ALWAYS, 0,0,0 },
...
//    { "ascension",     do_ascension, POS_DEAD,                 3,  LOG_NORMAL, 0,0,0 },
    ...
    { "mgore",              do_mgore, POS_FIGHTING,                 3,  LOG_NORMAL, 0,0,0 },
    { "phase",              do_phase, POS_FIGHTING,                 3,  LOG_NORMAL, 0,0,0 },
    { "frage",              do_frage, POS_FIGHTING,                 3,  LOG_NORMAL, 0,0,0 },
    { "hspit",              do_hspit, POS_FIGHTING,                 3,  LOG_NORMAL, 0,0,0 },
    { "turnhead",           do_turnhead, POS_FIGHTING,                 3,  LOG_NORMAL, 0,0,0 },
    { "spectouch",          do_spectouch, POS_FIGHTING,                 3,  LOG_NORMAL, 0,0,0 },
    { "mcharge",            do_mcharge, POS_FIGHTING,                 3,  LOG_NORMAL, 0,0,0 },
    { "spectralhand",       do_spectralhand, POS_FIGHTING,                 3,  LOG_NORMAL, 0,0,0 },
    { "howl",               do_howl, POS_FIGHTING,                 3,  LOG_NORMAL, 0,0,0 },
    { "gentletouch",        do_gentletouch, POS_FIGHTING,                 3,  LOG_NORMAL, 0,0,0 },
    { "snakebite",          do_snakebite, POS_FIGHTING,                 3,  LOG_NORMAL, 0,0,0 },
    { "scharm",             do_scharm, POS_FIGHTING,                 3,  LOG_NORMAL, 0,0,0 },
    { "csting",             do_csting, POS_FIGHTING,                 3,  LOG_NORMAL, 0,0,0 },
    { "chimeraattack",      do_chimeraattack, POS_FIGHTING,                 3,  LOG_NORMAL, 0,0,0 },
    { "cerberusattack",     do_cerberusattack, POS_FIGHTING,                 3,  LOG_NORMAL, 0,0,0 },
    { "cyclopsattack",      do_cyclopsattack, POS_FIGHTING,                 3,  LOG_NORMAL, 0,0,0 },
    { "minotaurattack",     do_minotaurattack, POS_FIGHTING,                 3,  LOG_NORMAL, 0,0,0 },
    { "griffinattack",      do_griffinattack, POS_FIGHTING,                 3,  LOG_NORMAL, 0,0,0 },
    { "satyrattack",        do_satyrattack, POS_FIGHTING,                 3,  LOG_NORMAL, 0,0,0 },
    { "centaurattack",      do_centaurattack, POS_FIGHTING,                 3,  LOG_NORMAL, 0,0,0 },
    { "bless",              do_bless, POS_STANDING,                 3,  LOG_NORMAL, 0,0,0 },
    { "eagleeye",           do_eagleeye, POS_STANDING,                 3,  LOG_NORMAL, 0,0,0 },
    { "cerberusform",       do_cerberusform, POS_STANDING,                 3,  LOG_NORMAL, 0,0,0 },
    { "fenrisform",         do_fenrisform, POS_STANDING,                 3,  LOG_NORMAL, 0,0,0 },
    { "chimeraform",        do_chimeraform, POS_STANDING,                 3,  LOG_NORMAL, 0,0,0 },
    { "griffinform",        do_griffinform, POS_STANDING,                 3,  LOG_NORMAL, 0,0,0 },
    { "vswoop",             do_vswoop, POS_STANDING,                 3,  LOG_NORMAL, 0,0,0 },
    { "gswoop",             do_gswoop, POS_STANDING,                 3,  LOG_NORMAL, 0,0,0 },
    { "hscream",            do_hscream, POS_FIGHTING,                 3,  LOG_NORMAL, 0,0,0 },
    { "bite",               do_bite, POS_FIGHTING,                 3,  LOG_NORMAL, 0,0,0 },
    { "vcurse",             do_vcurse, POS_FIGHTING,                 3,  LOG_NORMAL, 0,0,0 },

    { "racedetox",          do_racedetox, POS_STANDING,                 3,  LOG_NORMAL, 0,0,0 },
...
// Drexx
  ...
  */
    ...
    { "pholyaura",      do_pholyaura,    POS_FIGHTING,   3, LOG_NORMAL, CLASS_PALADIN,0,0},
...
// Chimerstry
        {"mirror", do_mirror, POS_STANDING, 3, LOG_ALWAYS, 4, DISC_VAMP_CHIM,
         1},
        {"formillusion", do_formillusion, POS_STANDING, 3, LOG_ALWAYS, 4, DISC_VAMP_CHIM, 2},
        {"controlclone", do_control, POS_STANDING, 3, LOG_ALWAYS, 4, DISC_VAMP_CHIM, 4},
        ...
        {"consent", do_consent, POS_STANDING, 1, LOG_ALWAYS, 0, 0, 0},
        ...
        {"godsfavor", do_godsfavor, POS_DEAD, 3, LOG_NORMAL, CLASS_MONK, 0, 0},
        ...
        {"embrace", do_embrace, POS_STANDING, 3, LOG_NORMAL, 4, 0, 0},
        {"diablerise", do_diablerise, POS_STANDING, 3, LOG_NORMAL, 4, 0, 0},
...
/* need it before forge */
         ...
         * Monk
         */
        {"chaoshands", do_chands, POS_STANDING, 3, LOG_NORMAL, CLASS_MONK, 0, 0},
        //{ "monkarmor",    do_monkarmor,   POS_STANDING,    3,  LOG_NORMAL, CLASS_MONK,0,0 },
        {"ghold", do_ghold, POS_STANDING, 3, LOG_NORMAL, CLASS_MONK, 0, 0},
        {"godsheal", do_godsheal, POS_FIGHTING, 3, LOG_NORMAL, CLASS_MONK, 0, 0},
        {"mantra", do_mantra, POS_STANDING, 3, LOG_NORMAL, CLASS_MONK, 0, 0},
        {"guide", do_guide, POS_STANDING, 3, LOG_NORMAL, CLASS_MONK, 0, 0},
        {"wrathofgod", do_wrathofgod, POS_FIGHTING, 3, LOG_NORMAL, CLASS_MONK, 0, 0},
        {"cloak", do_cloak, POS_STANDING, 3, LOG_NORMAL, CLASS_MONK, 0, 0},
        {"prayofages", do_prayofages, POS_FIGHTING, 3, LOG_NORMAL, CLASS_MONK, 0, 0},
        {"sacredinvis", do_sacredinvis, POS_STANDING, 3, LOG_NORMAL, CLASS_MONK, 0,
         0},
        {"flaminghands", do_flaminghands, POS_STANDING, 3, LOG_NORMAL, CLASS_MONK, 0,
         0},
        {"darkblaze", do_darkblaze, POS_FIGHTING, 3, LOG_NORMAL, CLASS_MONK, 0, 0},
        {"adamantium", do_adamantium, POS_STANDING, 3, LOG_NORMAL, CLASS_MONK, 0, 0},
        {"godseye", do_godseye, POS_STANDING, 3, LOG_NORMAL, CLASS_MONK, 0, 0},
        {"celestial", do_celestial, POS_STANDING, 3, LOG_NORMAL, CLASS_MONK, 0, 0},
        {"steelskin", do_steelskin, POS_STANDING, 3, LOG_NORMAL, CLASS_MONK, 0, 0},
        {"godsbless", do_godsbless, POS_FIGHTING, 3, LOG_NORMAL, CLASS_MONK, 0, 0},
        {"thrustkick", do_thrustkick, POS_FIGHTING, 3, LOG_NORMAL, CLASS_MONK, 0, 0},
        {"spinkick", do_spinkick, POS_FIGHTING, 3, LOG_NORMAL, CLASS_MONK, 0, 0},
        {"backfist", do_backfist, POS_FIGHTING, 3, LOG_NORMAL, CLASS_MONK, 0, 0},
        {"elbow", do_elbow, POS_FIGHTING, 3, LOG_NORMAL, CLASS_MONK, 0, 0},
        {"sweep", do_sweep, POS_FIGHTING, 3, LOG_NORMAL, CLASS_MONK, 0, 0},
        {"reverse", do_reverse, POS_FIGHTING, 3, LOG_NORMAL, CLASS_MONK, 0, 0},
        {"knee", do_knee, POS_FIGHTING, 3, LOG_NORMAL, CLASS_MONK, 0, 0},
        {"shinkick", do_shinkick, POS_FIGHTING, 3, LOG_NORMAL, CLASS_MONK, 0, 0},
        {"palmstrike", do_palmstrike, POS_FIGHTING, 3, LOG_NORMAL, CLASS_MONK, 0, 0},
        {"spiritpower", do_spiritpower, POS_FIGHTING, 3, LOG_NORMAL, CLASS_MONK, 0,
         0},
        {"deathtouch", do_deathtouch, POS_STANDING, 3, LOG_NORMAL, CLASS_MONK, 0, 0},
        {"relax", do_relax, POS_FIGHTING, 3, LOG_NORMAL, CLASS_MONK, 0, 0},
        {"monktalk", do_monktalk, POS_DEAD, 3, LOG_NORMAL, CLASS_MONK, 0, 0},
...
// Metis
        {"quills", do_quills, POS_FIGHTING, 3, LOG_NORMAL, 3, DISC_WERE_HAWK,
         5},
        {"burrow", do_burrow, POS_STANDING, 3, LOG_NORMAL, 3, DISC_WERE_HAWK,
         6},
        {"nightsight", do_nightsight, POS_FIGHTING, 3, LOG_NORMAL, CLASS_WEREWOLF,
         DISC_WERE_HAWK, 1},

        {"learn", do_learn, POS_FIGHTING, 3, LOG_NORMAL, CLASS_MONK, 0, 0},

        /*
         * Vampire and werewolf commands.
         */
        //{ "vamparmor",    do_vampirearmor, POS_STANDING, 3, LOG_NORMAL, 4, 0, 0 },
        {"bloodwall", do_bloodwall, POS_STANDING, 3, LOG_NORMAL, 4,
         DISC_VAMP_DAIM, 2},
        {"conceal", do_conceal, POS_STANDING, 3, LOG_NORMAL, 4,
         DISC_VAMP_OBFU, 5},
        {"sharpen", do_sharpen, POS_STANDING, 3, LOG_NORMAL, 4,
         DISC_VAMP_QUIE, 7},
        ...
        {"shadowgaze", do_shadowgaze, POS_STANDING, 3, LOG_NORMAL, 4,
         DISC_VAMP_OBTE, 10},
        ...
        {"calm", do_calm, POS_STANDING, 3, LOG_NORMAL, CLASS_DEMON,
         DISC_DAEM_ATTA, 4},
        {"vamptalk", do_vamptalk, POS_DEAD, 1, LOG_NORMAL, 4, 0, 0},
...
/* Vamp ^^^^ */
        ...
        {"talons", do_talons, POS_FIGHTING, 3, LOG_NORMAL, 3, DISC_WERE_RAPT,
         10},
        {"bonemod", do_bonemod, POS_STANDING, 3, LOG_NORMAL, 4,
         DISC_VAMP_VICI, 3},
        {"cauldron", do_cauldron, POS_FIGHTING, 3, LOG_NORMAL, 4,
         DISC_VAMP_THAU, 2},
        {"flamehands", do_flamehands, POS_FIGHTING, 3, LOG_NORMAL, 4,
         DISC_VAMP_PROT, 5},
        ...
        {"infirmity", do_infirmity, POS_FIGHTING, 3, LOG_NORMAL, 4,
         DISC_VAMP_QUIE, 2},
        ...
        {"shadowstep", do_shadowstep, POS_STANDING, 3, LOG_NORMAL, 4,
         DISC_VAMP_OBTE, 4},
        {"claws", do_claws, POS_SITTING, 3, LOG_NORMAL, 4, DISC_VAMP_PROT, 2},
        {"darkheart", do_darkheart, POS_STANDING, 3, LOG_NORMAL, 4,
         DISC_VAMP_SERP, 1},
        {"earthmeld", do_earthmeld, POS_STANDING, 3, LOG_NORMAL, 4,
         DISC_VAMP_PROT, 4},
        {"burrow", do_burrow, POS_STANDING, 3, LOG_NORMAL, 3, DISC_WERE_BOAR,
         5},
        {"fangs", do_fangs, POS_SITTING, 3, LOG_NORMAL, 4, 0, 0},
        {"flex", do_flex, POS_SITTING, 0, LOG_NORMAL, 0, 0, 0},
        {"gcommand", do_fcommand, POS_STANDING, 3, LOG_NORMAL, 0, 0, 0},
        {"possession", do_possession, POS_STANDING, 3, LOG_NORMAL, 4,
         DISC_VAMP_DOMI, 3},
        ...
        {"plasma", do_plasma, POS_STANDING, 3, LOG_NORMAL, 4, DISC_VAMP_VICI,
         5},
        {"zuloform", do_zuloform, POS_FIGHTING, 3, LOG_NORMAL, 4,
         DISC_VAMP_VICI, 2},
       ...
       {"mienaku", do_mienaku, POS_FIGHTING, 3, LOG_NORMAL, CLASS_NINJA, 0, 0},
        ...
        {"newbiepack", do_newbiepack, POS_SLEEPING, 1, LOG_ALWAYS, 0, 0, 0},
        ...
        {"rshow",  do_showrelevel, POS_DEAD, 12, LOG_NORMAL, 0,0,0 },
...
/* vamp protean healing*/
        {"healing", do_healing, POS_FIGHTING, 3, LOG_NORMAL, 4,
         DISC_VAMP_PROT, 8},
        {"healingtouch", do_healingtouch, POS_STANDING, 3, LOG_NORMAL, CLASS_MONK, 0, 0},   /*monks healing power */
        {"inconnu", do_inconnu, POS_STANDING, 3, LOG_NORMAL, 4, 0, 0},
        {"majesty", do_majesty, POS_STANDING, 3, LOG_NORMAL, 4,
         DISC_VAMP_PRES, 5},
        {"nightsight", do_nightsight, POS_SITTING, 3, LOG_NORMAL, 4,
         DISC_VAMP_PROT, 1},
        {"poison", do_poison, POS_STANDING, 3, LOG_NORMAL, 4, DISC_VAMP_SERP,
         3},
        {"rage", do_rage, POS_FIGHTING, 3, LOG_NORMAL, CLASS_WEREWOLF, 0, 0},
        {"regenerate", do_regenerate, POS_SLEEPING, 3, LOG_NORMAL, 4, 0, 0},
        {"roll", do_roll, POS_RESTING, 2, LOG_NORMAL, 1, 0, 0},
        {"stake", do_stake, POS_STANDING, 3, LOG_NORMAL, 0, 0, 0},
        {"serpent", do_serpent, POS_STANDING, 3, LOG_NORMAL, 4,
         DISC_VAMP_SERP, 2},
        ...
        {"shadowsight", do_shadowsight, POS_SITTING, 3, LOG_NORMAL, CLASS_WEREWOLF,
         DISC_WERE_HAWK, 2},
        {"serenity", do_serenity, POS_SITTING, 3, LOG_NORMAL, 4,
         DISC_VAMP_ANIM, 2},
        {"totems", do_totems, POS_SITTING, 3, LOG_NORMAL, CLASS_WEREWOLF, 0, 0},
...
/* Tag commands */
        ...
        {"oilspit", do_stuntubes, POS_FIGHTING, 3, LOG_NORMAL, CLASS_CYBORG, 0, 0},
        {"terminator", do_cubeform, POS_STANDING, 3, LOG_NORMAL, CLASS_CYBORG, 0, 0},
        {"implant", do_implant, POS_STANDING, 0, LOG_NORMAL, CLASS_CYBORG, 0, 0},
        {"scry", do_scry, POS_STANDING, 3, LOG_NORMAL, CLASS_CYBORG, 0, 0},
        {"readaura", do_readaura, POS_STANDING, 3, LOG_NORMAL, CLASS_CYBORG, 0, 0},
        {"lloth", do_lloth, POS_STANDING, 3, LOG_NORMAL, CLASS_CYBORG, 0, 0},
        {"darkness", do_darkness, POS_STANDING, 3, LOG_NORMAL, CLASS_CYBORG, 0, 0},
        {"mechsight", do_infravision, POS_STANDING, 3, LOG_NORMAL, CLASS_CYBORG, 0,
         0},
        //{ "cyborgeq",       do_cyborgeq,    POS_STANDING,   3,      LOG_NORMAL, CLASS_CYBORG,0,0}, 
        {"web", do_web, POS_FIGHTING, 3, LOG_NORMAL, CLASS_CYBORG, 0, 0},
        {"transmit", do_transmit, POS_DEAD, 3, LOG_NORMAL, CLASS_CYBORG, 0, 0},
        {"upload", do_shadowwalk, POS_STANDING, 3, LOG_NORMAL, CLASS_CYBORG, 0, 0},
        ...
        {"buy", do_buy, POS_STANDING, 1, LOG_ALWAYS, 0, 0, 0},
        {"sell", do_sell, POS_STANDING, 1, LOG_ALWAYS, 0, 0, 0},
        ...
        {"shoot", do_shoot, POS_STANDING, 1, LOG_NORMAL, 0, 0, 0},
        {"reload", do_reload, POS_STANDING, 1, LOG_NORMAL, 0, 0,
         0},
        {"unload", do_unload, POS_STANDING, 1, LOG_NORMAL, 0, 0,
         0},
        /*
         * Immortal commands.
         */
	...
	{"tiercap", do_tiercap, POS_STANDING, 3, LOG_NORMAL, 0, 0, 0},
        ...
        {"kdeposit", do_kdeposit, POS_STANDING, 2, LOG_ALWAYS, 0, 0, 0},
	...
	{"kwithdraw", do_kwithdraw, POS_STANDING, 3, LOG_ALWAYS, 0, 0, 0},
	{"defect", do_defect, POS_STANDING, 2, LOG_NORMAL, 0, 0, 0},
        ...
        {"deposit", do_deposit, POS_STANDING, 2, LOG_ALWAYS, 0, 0, 0},
        {"withdraw", do_withdraw, POS_STANDING, 2, LOG_ALWAYS, 0, 0, 0},
