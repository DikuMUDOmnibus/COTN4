...
/* Cotn Races by Xrakisis */

#define RACE_HUMAN 			1
#define RACE_CHIMERA 		2
#define RACE_CERBERUS 	3
#define RACE_CYCLOPS 		4
#define RACE_GRIFFIN		5
#define RACE_HARPIE			6
#define RACE_PHOENIX		7
#define RACE_SATYR			8
#define RACE_MEDUSA			9
#define RACE_TITAN			10
#define RACE_FENRIS			11
#define RACE_NYMPH			12
#define RACE_SPECTRE		13
#define RACE_MINOTAUR		15
#define RACE_CENTAUR    16
#define RACE_VALKYRIE		17
