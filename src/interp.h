...
DECLARE_DO_FUN(do_mgore);
DECLARE_DO_FUN(do_phase);
DECLARE_DO_FUN(do_frage);
DECLARE_DO_FUN(do_csting);
DECLARE_DO_FUN(do_hspit);
DECLARE_DO_FUN(do_turnhead);
DECLARE_DO_FUN(do_spectouch);
DECLARE_DO_FUN(do_mcharge);
DECLARE_DO_FUN(do_spectralhand);
DECLARE_DO_FUN(do_fhowl);
DECLARE_DO_FUN(do_gentletouch);
DECLARE_DO_FUN(do_snakebite);
DECLARE_DO_FUN(do_scharm);
DECLARE_DO_FUN(do_vcurse);
DECLARE_DO_FUN(do_bite);
DECLARE_DO_FUN(do_hscream);
DECLARE_DO_FUN(do_vswoop);
DECLARE_DO_FUN(do_gswoop);
DECLARE_DO_FUN(do_chimeraattack);
DECLARE_DO_FUN(do_cerberusattack);
DECLARE_DO_FUN(do_cyclopsattack);
DECLARE_DO_FUN(do_minotaurattack);
DECLARE_DO_FUN(do_griffinattack);
DECLARE_DO_FUN(do_satyrattack);
DECLARE_DO_FUN(do_centaurattack);
DECLARE_DO_FUN(do_bless);
DECLARE_DO_FUN(do_eagleeye);
DECLARE_DO_FUN(do_cerberusform);
DECLARE_DO_FUN(do_fenrisform);
DECLARE_DO_FUN(do_chimeraform);
DECLARE_DO_FUN(do_griffinform);
DECLARE_DO_FUN(do_racedetox);
...
//Korax Stuff
DECLARE_DO_FUN(do_showrelevel);

//Zazel Stuff
DECLARE_DO_FUN( do_chathist  );
DECLARE_DO_FUN( do_zhistory  );
