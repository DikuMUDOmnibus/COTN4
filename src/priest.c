...
void do_minheal(CHAR_DATA * ch, char *argument)
{
        ...
        act("$n's eyes start to glow #wbright white#n.", ch, NULL, NULL,
            TO_ROOM);
...
void do_majorheal(CHAR_DATA * ch, char *argument)
{
        ...
        {
                send_to_char
                        ("You need to gain minor healing to use this!\n\r",
                         ch);
                return;
        }
...
void do_grheal(CHAR_DATA * ch, char *argument)
{
        ...
        {
                send_to_char
                        ("You need to gain major healing to use this!\n\r",
                         ch);
                return;
        }
...
void do_godheal(CHAR_DATA * ch, char *argument)
{
        ...
        {
                send_to_char
                        ("You need to gain greater healing to use this!\n\r",
                         ch);
                return;
        }
        ...
        {
                send_to_char
                        ("You need to gain healing storm to use this!\n\r",
                         ch);
                return;
        }
        ...
        {
                send_to_char
                        ("You need to master major healing storm to use this!\n\r",
                         ch);
                return;
        }
        ...
        {
                send_to_char
                        ("You need to master greater healing storm to use this!\n\r",
                         ch);
                return;
        }
...
void do_minstorm(CHAR_DATA * ch, char *argument)
{
        ...
        {
                send_to_char
                        ("You haven't mastered major healing storm yet!\n\r",
                         ch);
                return;
        }
...
void do_grstorm(CHAR_DATA * ch, char *argument)
{
        ...
        {
                send_to_char
                        ("You need to gain major healing storm to use this!\n\r",
                         ch);
                return;
        }
        ...
        {
                send_to_char
                        ("You haven't mastered greater healing storm yet!\n\r",
                         ch);
                return;
        }
...
void do_godbless(CHAR_DATA * ch, char *argument)
{
        ...
        if ((sn = skill_lookup("greater bless")) < 0)
                return;
...
void do_godstrike(CHAR_DATA * ch, char *argument)
{
        ...
        {
                send_to_char
                        ("You need to gain greater healing strom to use this!\n\r",
                         ch);
                return;
        }
        ...
        if (ch->position != POS_FIGHTING)
        {
                ...
                if (!IS_NPC(victim))
                        atkdam /= 2;
                xprintf(buf,
                        "Your GodStrike #w-#w-#0-#b*#B*#0*#w(#s MUTILATES #w)#0*#B*#b*#0-#w-#w-#n %s. #B[#w%d#B]#n\n\r",
                        victim->name, atkdam);
                stc(buf, ch);
                xprintf(buf,
                        "%s's GodStrike #w-#w-#0-#b*#B*#0*#w(#s MUTILATES #w)#0*#B*#b*#0-#w-#w-#n you! #B[#w%d#B]#n\n\r",
                        ch->name, atkdam);
                stc(buf, victim);
...
void do_godpeace(CHAR_DATA * ch, char *argument)
{
        ...
        {
                send_to_char
                        ("You need to gain greater healing storm to use this!\n\r",
                         ch);
                return;
        }
...
void do_pwho(CHAR_DATA * ch, char *argument)
{
        ...
        send_to_char(buf, ch);
        send_to_char
                ("#0[#C      Name      #0] [#C Hits #0] [#C Mana #0] [#C Move #0]#n\n\r",
                 ch);
        for (gch = char_list; gch != NULL; gch = gch->next)
        {
                if (IS_NPC(gch))
...
void do_priestform(CHAR_DATA * ch, char *argument)
{
        ...
        act("$n's body grows and distorts into a huge priest.", ch, NULL,
            NULL, TO_ROOM);
