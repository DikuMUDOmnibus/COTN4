...
const struct pc_looks pc_looks_table [] =
{
	...
	{"has a massive scale covered body"},
	{"has a scale covered body"}
...
const struct pc_build pc_build_table [] =
{
	...
	{"stocky"},
	{"althleticly built"},
	{"tall and muscular with a long tail"}
};
...
const struct pc_hair pc_hair_table [] =
{
	{"null"},
        ...
        {"short black hair"},
        {"long black hair"},
	{"two deadly horns on their head"}
};
 ...
 */
    ...
    {
        "aura of takhisis",               1,5,
        spell_null,             TAR_IGNORE,             POS_STANDING,
        &gsn_takaura,            SLOT( 0),        0,     24,
        "aura of Takhisis",         "aura of Takhisis!"
     },
	...
	"malice",		"!Malice!"
        ...
        {
         "faith armor", 13, 37,
         spell_farmor, TAR_CHAR_DEFENSIVE, POS_STANDING,
         NULL, SLOT(55), 99, 12,
         "", "Your armor of faith fades."},
...

        {
         ...
         NULL, SLOT(203), 300, 8, // 8 was a 4 -xrak
         "blast of gas", "!Gas Breath!"},

        {
         "lightning breath", 1, 75,
        ...
        {
         "soulblade", 1, 0,
         spell_soulblade, TAR_IGNORE, POS_STANDING,
...
*/
...

        {
         "berserk", 2, 0,
         spell_null, TAR_IGNORE, POS_FIGHTING,
         &gsn_berserk, SLOT(0), 0, 6,
         "", "!Berserk!"},

        {
         "protection vs good", 1, 20,
	 ...
	 spell_null, TAR_IGNORE, POS_STANDING,
        ...
        {
         "wrath of god", 13, 0,spell_null, TAR_IGNORE, POS_STANDING,
         &gsn_wrathofgod, SLOT(0), 0, 24, "wrath of god", "wrath of god!"},
        {
         "darktendrils", 13, 0, spell_null, TAR_IGNORE, POS_STANDING,
         &gsn_darktendrils, SLOT(0), 0, 24, "darktendrils", "darktendrils!"},
        {
         "fiery aura", 13, 0, spell_null, TAR_IGNORE, POS_STANDING,
         &gsn_fiery, SLOT(0), 0, 24, "fiery aura", "fiery aura!"},
        {
         "chillhand", 13, 0, spell_null, TAR_IGNORE, POS_STANDING,
         &gsn_chillhand, SLOT(0), 0, 24, "chillhand", "chillhand!"},
        {
         "booming voice", 13, 0, spell_null, TAR_IGNORE, POS_STANDING,
        ...
        {
         "forcebless", 12, 0,
         spell_forcebless, TAR_CHAR_DEFENSIVE, POS_STANDING,
         NULL, SLOT(205), 5, 12,
         "", "You feel your force blessing leave you."},
        ...
        {"knife spin", 99, 0, spell_null, TAR_IGNORE, POS_STANDING,
         &gsn_knifespin, SLOT(0), 0, 24,
         "knife spin", "Bug: not a spell"},
        {"wakasashi slice", 99, 0, spell_null, TAR_IGNORE, POS_STANDING,
         &gsn_wakasashislice, SLOT(0), 0, 24,
         "wakasashi slice", "Bug: not a spell"},
        {"caltrop toss", 99, 0, spell_null, TAR_IGNORE, POS_STANDING,
         &gsn_caltrops, SLOT(0), 0, 24,
         "caltrop toss", "Bug: not a spell"},
        {"soulreaper", 99, 0, spell_null, TAR_IGNORE, POS_STANDING,
         &gsn_soulreaper, SLOT(0), 0, 24,
         "soulreaper", "Bug: not a spell"},
        {"", 99, 0,  spell_null, TAR_IGNORE, POS_STANDING,
         &gsn_moonstrike, SLOT(0), 0, 24,
         "moonstrike", "Bug: not a spell"},
        {"shadow thrust", 99, 0, spell_null, TAR_IGNORE, POS_STANDING,
         &gsn_shadowthrust, SLOT(0), 0, 24,
         "shadow thrust", "Bug: not a spell"},
        {"gutcutter", 99, 0, spell_null, TAR_IGNORE, POS_STANDING,
         &gsn_gutcutter, SLOT(0), 0, 24,
         "gutcutter", "Bug: not a spell"},
        {"dirtthrow", 99, 0, spell_null, TAR_IGNORE, POS_STANDING,
         &gsn_dirtthrow, SLOT(0), 0, 24,
         "dirtthrow", "Bug: not a spell"},

        {
         "soul seeker", 13, 0, 
         spell_null, TAR_IGNORE, POS_STANDING,
         &gsn_soulseeker, SLOT(0), 0, 24,
         "soul seeker", "!Dirt!"},

        {
         "greater bless", 99, 0, 
         spell_greaterbless, TAR_IGNORE, POS_STANDING,
         NULL, SLOT(522), 15, 12,
         "", "Your Greater Bless fades away."},
         ...
         "", "The clay on your body melts away."},
        {
         ...
         "", "!Group Heal!"},
        {
         "supreme attack", 99, 0,  spell_null, TAR_IGNORE,
         POS_STANDING, &gsn_supreme, SLOT(0), 0, 24,
         "supreme attack", "whatever"},
        {
         "thrown pie", 99, 0, spell_null, TAR_IGNORE,
         POS_STANDING, &gsn_thrownpie, SLOT(0), 0, 24,
         "thrown pie", "whatever"},
        {
         "#C*#wSmAcK#C*#n", 99, 0, spell_null, TAR_IGNORE,
         POS_STANDING, &gsn_smack, SLOT(0), 0, 24,
         "#C*#wSmAcK#C*#n", "whatever"},
        {
         "#C*#wBaSh#C*#n", 99, 0, spell_null, TAR_IGNORE,
         POS_STANDING, &gsn_bash, SLOT(0), 0, 24,
         "#C*#wBaSh#C*#n", "whatever"},
        {
         "#C*#wThWaCk#C*#n", 99, 0, spell_null, TAR_IGNORE,
         POS_STANDING, &gsn_thwack, SLOT(0), 0, 24,
         "#C*#wThWaCk#C*#n", "whatever"},
        {
         "shimmering_plasma", 99, 0, spell_null, TAR_IGNORE,
         POS_STANDING, &gsn_plasma, SLOT(0), 0, 24,
         "shimmering plasma", "whatever"},
        {
         "telekinetic burst", 99, 0, spell_null, TAR_IGNORE,
         POS_STANDING, &gsn_telekinetic, SLOT(0), 0, 24,
         "telekinetic burst", "whatever"},
        {
         "burning hot mocha", 99, 0, spell_null, TAR_IGNORE,
         POS_STANDING, &gsn_mocha, SLOT(0), 0, 24,
         "burning hot mocha", "whatever"},
        {
         "potato grenade", 99, 0, spell_null, TAR_IGNORE,
         POS_STANDING, &gsn_potato, SLOT(0), 0, 24,
         "potato grenade", "whatever"},
        {
         "breath", 13, 0, spell_null, TAR_IGNORE, POS_STANDING,
        ...
        {
         "#C*#7Tattoo Magic#C*#n", 99, 0, spell_null, TAR_IGNORE,
         POS_STANDING, &gsn_tattoo, SLOT(0), 0, 24,
         "#C*#7Tattoo Magic#C*#n", "whatever"},

        {
         "heal2", 99, 0,
         spell_heal2, TAR_CHAR_DEFENSIVE, POS_FIGHTING,
         NULL, SLOT(28), 50, 12,
         "", "!Heal!"},

        {
         "darmor", 99, 0,
         spell_darmor, TAR_CHAR_DEFENSIVE, POS_STANDING,
         NULL, SLOT(1), 5, 12,
...

        {
         "pure faith", 13, 0,
         spell_null, TAR_IGNORE, POS_STANDING,
         &gsn_faith, SLOT(0), 0, 24,
         "pure faith", "pure faith!"},

        {
         "thorny brambles", 13, 0,
         spell_null, TAR_IGNORE, POS_STANDING,
         &gsn_thorns, SLOT(0), 0, 24,
         "thorny brambles", "thorny brambles!"},

        {
         "blast of steam", 99, 0,
         spell_null, TAR_IGNORE, POS_STANDING,
         &gsn_steam, SLOT(0), 0, 0,
         "blast of steam", "!steam!"},
        {
         "rocket blast", 99, 0,
         spell_null, TAR_IGNORE, POS_STANDING,
         &gsn_rocket, SLOT(0), 0, 0,
         "rocket blast", "!rocket!"},
        {
         "machinegun salve", 99, 0,
         spell_null, TAR_IGNORE, POS_STANDING,
         &gsn_machinegun, SLOT(0), 0, 0,
         "machinegun salve", "!gun!"},
         ...
         NULL, "Your paradox fades."},
     {
        "retribution",          99, 0,
        spell_null,             TAR_IGNORE,             POS_STANDING,
        &gsn_retribution,               SLOT( 0),       0,      24,
        "retribution",          "!Retribution!"
     },
    {
        "holy aura",               13, 0,
        spell_null,             TAR_IGNORE,             POS_STANDING,
        &gsn_holyaura,            SLOT( 0),        0,     24,
        "holy aura",         "!holy aura!"
     },
    {
        "stench",               13, 0,
        spell_null,             TAR_IGNORE,             POS_STANDING,
        &gsn_stench,            SLOT( 0),        0,     24,
        "stench",         "!stench!"
     },
    {
        "zomplague",               13, 0,
        spell_null,             TAR_IGNORE,             POS_STANDING,
        &gsn_zomplague,            SLOT( 0),        0,     24,
        "zomplague",         "!zomplague!"
     },
//Shinobi

	{
	"bloody shuriken",		13, 0,
	spell_null,		TAR_IGNORE,		POS_STANDING,
	&gsn_shinfire,		SLOT(0),		0,	24,
	"bloody shuriken",	"!?"
	},
	{
	"chains",		13, 0,
	spell_null,		TAR_IGNORE,		POS_STANDING,
	&gsn_shinwater,		SLOT(0),		0,	24,
	"chains",		"!?"
	},
	{
	"sickles",		13, 0,
	spell_null,		TAR_IGNORE,		POS_STANDING,
	&gsn_shinwind,		SLOT(0),		0,	24,
	"sickles",		"!?"
	},
	{
	"spiked stones",		13, 0,
	spell_null,		TAR_IGNORE,		POS_STANDING,
	&gsn_shinearth,		SLOT(0),		0,	24,
	"spiked stones",	"!?"
	},
	{
	"holy energies",		13, 0,
	spell_null,		TAR_IGNORE,		POS_STANDING,
	&gsn_shinholy,		SLOT(0),		0,	24,
	"holy energies",	"!?"
	},
	{
	"katana",		13,0,
	spell_null,		TAR_IGNORE,		POS_STANDING,
	&gsn_shinshadow,		SLOT(0),		0,	24,
	"katana",	"!?"
	},
	{
	"kamas",		13, 0,
	spell_null,		TAR_IGNORE,		POS_STANDING,
	&gsn_shin,		SLOT(0),		0,	24,
	"kamas",		"!?"
	},
     {
 	"shinobi bless",	99, 0,
 	spell_null,		TAR_IGNORE,		POS_STANDING,
 	NULL,			SLOT(400),		 0,	0,
 	"",			"The shinobi bless on you vanishes."
     },
     {
        "requiem",          99, 0,
        spell_null,             TAR_IGNORE,             POS_STANDING,
...
void do_slay(CHAR_DATA * ch, char *argument)
{
        ...
        if ((victim = get_char_room(ch, NULL, who)) == NULL)
        {
        ...
        else if (!IS_NPC(victim) && get_trust(victim) >= get_trust(ch))
        {
