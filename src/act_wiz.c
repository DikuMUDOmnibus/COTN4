...
void do_toggle(CHAR_DATA * ch, char *argument)
{
	    ...
	    && !strcmp(argument, "special_day"))
        {
                send_to_char("Syntax: toggle <bones|exp|cp|dt|special_day|all> <on|off>.\n\r",
                             ch);
                return;
        }
